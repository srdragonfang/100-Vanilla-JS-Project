...
taskSubmit.addEventListener('click', () => {
	if (taskInput.value === '') {
		...
		console.log('check input value conditional:', taskInput.value !== '');
		createNewTask();
		console.log('kanbanAppDev', getTasksFromLocalStorage());
	}
});
...
function getTasksFromLocalStorage() {
	const items = JSON.parse(localStorage.getItem('kanbanAppDev'));
...
function addTaskToLocalStorage(item) {
	...
	localStorage.setItem('kanbanAppDev', JSON.stringify([...roses, item]));
}
...
function removeTaskFromLocalStorage(id) {
	...
	localStorage.setItem('kanbanAppDev', JSON.stringify(tasks));
}
